...
global.email     = 'geemkuu0@gmail.com' ; 
global.github    = 'https://github.com/Geemkuu/SIGMA-MD' ;
global.location  = 'hapo nje ,kwenyu' ;
global.website   = 'https://Whatsapp.com/chat/254700569709?text=hey+gee' ; 
...
global.sudo  =  process.env.SUDO || "254700569709" ;          // DON'T REMOVE
global.mztit = process.env.MZTIT ||"★彡ＮＯＮＳＥＮＳＥ 彡★",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
global.gurl  = 'https://Whatsapp.com/chat/254700569709?text=hey+gee' ; 
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/45040426cb67297d211b8.jpg' ;
//=================================================================================
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '28_03_2024_SIGMA_MD_RjrEBEM9_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || '★彡ＮＯＮＳＥＮＳＥ 彡★',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `亗『ＧＥＥ』亗`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'gee',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "nonsense" ,          // ADD YOUR STICKER PACKNAME
  ...
  OPENAI_API_KEY: process.env.OPENAI_API_KEY ||'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' ,    // ADD YOUR OPEN AI KEY IF YOU HAVE
  ...
  caption :process.env.CAPTION || "*• ★彡ＮＯＮＳＥＮＳＥ 彡★*\n*• just nonsense* ",
